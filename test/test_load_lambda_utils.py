...
class TestGetQuery:
    def test_query_returns_correct_sql_insert_statement(self, s3_client):
        ...
        assert (
            result
            == "INSERT INTO dim_currency VALUES ('GBP', 'Pound Sterling'), ('USD', 'US Dollar');"
        )
